...
Sites use dark mode as a *supplemental overlay* or slot-based ui-module on top of the consumer's `ui.bundle`.
...
Former npm installs: xref:npm-distribution.adoc[npm distribution].
