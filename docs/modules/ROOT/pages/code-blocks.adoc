...
----
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/antora-supplemental/antora-dark-mode.git"
  }
}
----
...
The theme ships as a release `ui-bundle.zip` in your playbook (not npm).
The following commands run Antora and preview the site locally.
